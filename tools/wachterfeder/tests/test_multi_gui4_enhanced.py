...
from tools.wachterfeder import ck3_enhanced
...
class EnhancedFourGameUiTests(unittest.TestCase):
    def test_ck3_adapter_is_patched_into_four_game_shell(self) -> None:
        self.assertIs(base_ui.analyse_ck3_save, ck3_enhanced.analyse_ck3_save)
        self.assertIs(base_ui.find_rakaly, ck3_enhanced.find_rakaly)
